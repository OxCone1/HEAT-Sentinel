...
<!-- RELEASE-EN:START -->
[![Download HEAT Sentinel](https://img.shields.io/badge/Download-HEAT%20Sentinel%20v2.0.0-0a0a0a?style=for-the-badge&logo=github)](https://github.com/OxCone1/HEAT-Sentinel/releases/download/v2.0.0/HEAT.Sentinel_2.0.0_x64-setup.exe)

**Latest release:** [v2.0.0](https://github.com/OxCone1/HEAT-Sentinel/releases/tag/v2.0.0) -- published 2026-07-15

| File | Size | VirusTotal report |
|------|------|------|
| [`HEAT.Sentinel_2.0.0_x64-setup.exe`](https://github.com/OxCone1/HEAT-Sentinel/releases/download/v2.0.0/HEAT.Sentinel_2.0.0_x64-setup.exe) (app installer) | 179.9 MB | [View scan](https://www.virustotal.com/gui/file/9b4b460565fb1bb17b23325ec167acbaa118e7fd722eee2e2b08c31c8fdc17e7) |
| `heat-capture.exe` (capture/watcher engine, bundled inside the installer) | 86.3 MB | [View scan](https://www.virustotal.com/gui/file/a82303dfac2f5948da85472f9cccac8426ae5b01adbea12d8e9427b63ef3d216) |
<!-- RELEASE-EN:END -->
...
|---------------------------|---------------------------|
| 0. [Table of Contents (EN)](#0-table-of-contents-en)<br>1. [Navigation](#1-navigation)<br>2. [Project Overview](#2-project-overview)<br>3. [Installation and First Launch](#3-installation-and-first-launch)<br>4. [Stream Overlay and OBS Integration](#4-stream-overlay-and-obs-integration)<br>5. [Data Capture: Main Mode and Legacy OCR](#5-data-capture-main-mode-and-legacy-ocr)<br>6. [Calibrations and Patterns](#6-calibrations-and-patterns)<br>7. [Contributing](#7-contributing)<br>8. [Security and Privacy](#8-security-and-privacy)<br>9. [Future Expansion](#9-future-expansion)<br>10. [Disclaimer](#10-disclaimer) | 0. [Содержание (RU)](#0-содержание-ru)<br>1. [Навигация](#1-навигация)<br>2. [Обзор проекта](#2-обзор-проекта)<br>3. [Установка и первый запуск](#3-установка-и-первый-запуск)<br>4. [Оверлей для стрима и интеграция с OBS](#4-оверлей-для-стрима-и-интеграция-с-obs)<br>5. [Захват данных: основной режим и Legacy OCR](#5-захват-данных-основной-режим-и-legacy-ocr)<br>6. [Калибровки и паттерны](#6-калибровки-и-паттерны)<br>7. [Участие в проекте](#7-участие-в-проекте)<br>8. [Безопасность и приватность](#8-безопасность-и-приватность)<br>9. [Планы развития](#9-планы-развития)<br>10. [Дисклеймер](#10-дисклеймер) |
...
<!-- RELEASE-RU:START -->
[![Скачать HEAT Sentinel](https://img.shields.io/badge/%D0%A1%D0%BA%D0%B0%D1%87%D0%B0%D1%82%D1%8C-HEAT%20Sentinel%20v2.0.0-0a0a0a?style=for-the-badge&logo=github)](https://github.com/OxCone1/HEAT-Sentinel/releases/download/v2.0.0/HEAT.Sentinel_2.0.0_x64-setup.exe)

**Последний релиз:** [v2.0.0](https://github.com/OxCone1/HEAT-Sentinel/releases/tag/v2.0.0) -- опубликован 2026-07-15

| Файл | Размер | Отчёт VirusTotal |
|------|------|------|
| [`HEAT.Sentinel_2.0.0_x64-setup.exe`](https://github.com/OxCone1/HEAT-Sentinel/releases/download/v2.0.0/HEAT.Sentinel_2.0.0_x64-setup.exe) (установщик приложения) | 179.9 MB | [Открыть отчёт](https://www.virustotal.com/gui/file/9b4b460565fb1bb17b23325ec167acbaa118e7fd722eee2e2b08c31c8fdc17e7) |
| `heat-capture.exe` (движок захвата, встроен в установщик) | 86.3 MB | [Открыть отчёт](https://www.virustotal.com/gui/file/a82303dfac2f5948da85472f9cccac8426ae5b01adbea12d8e9427b63ef3d216) |
<!-- RELEASE-RU:END -->
...
|-----------------------|---------------------------|
| 0. [Содержание (RU)](#0-содержание-ru)<br>1. [Навигация](#1-навигация)<br>2. [Обзор проекта](#2-обзор-проекта)<br>3. [Установка и первый запуск](#3-установка-и-первый-запуск)<br>4. [Оверлей для стрима и интеграция с OBS](#4-оверлей-для-стрима-и-интеграция-с-obs)<br>5. [Захват данных: основной режим и Legacy OCR](#5-захват-данных-основной-режим-и-legacy-ocr)<br>6. [Калибровки и паттерны](#6-калибровки-и-паттерны)<br>7. [Участие в проекте](#7-участие-в-проекте)<br>8. [Безопасность и приватность](#8-безопасность-и-приватность)<br>9. [Планы развития](#9-планы-развития)<br>10. [Дисклеймер](#10-дисклеймер) | 0. [Table of Contents (EN)](#0-table-of-contents-en)<br>1. [Navigation](#1-navigation)<br>2. [Project Overview](#2-project-overview)<br>3. [Installation and First Launch](#3-installation-and-first-launch)<br>4. [Stream Overlay and OBS Integration](#4-stream-overlay-and-obs-integration)<br>5. [Data Capture: Main Mode and Legacy OCR](#5-data-capture-main-mode-and-legacy-ocr)<br>6. [Calibrations and Patterns](#6-calibrations-and-patterns)<br>7. [Contributing](#7-contributing)<br>8. [Security and Privacy](#8-security-and-privacy)<br>9. [Future Expansion](#9-future-expansion)<br>10. [Disclaimer](#10-disclaimer) |
